...
export default function Hero() {
  return (
    <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
      {/* Background with smooth zoom & blur animation */}
      <div className="absolute inset-0 -z-10 animate-zoomSlow">
        <Image
          src="/laptop.jpg"
          alt="Hero background"
          fill
      ...
      <div className="text-center px-4 z-10 animate-fadeIn">
        ...
        <p className="text-xl md:text-2xl max-w-xl mx-auto drop-shadow-lg">
          I build fast, modern web apps using Next.js & Tailwind.
        </p>
        <a
          href="/portfolio"
